...
public class AuthorServiceImpl implements AuthorService {
    ...
    public AuthorServiceImpl(AuthorRepo authorRepo, GenreRepo genreRepo, BookService bookService) {
    ...
    public Optional<AuthorRequestDto> getByID(Long id) {
        ...
        else throw new ResourceNotFoundException("The author with ID %d is not found", id);
    }
    ...
    public Set<AuthorResponseDto> getAuthorsByGenreName(String name) {
        if (!genreRepo.existsByGenreName(name))
            throw new ResourceNotFoundException("The genre %s is not found or doesn't exist", name);
        else {
...
//            return authorList.stream().map(Author::convertAuthorToResponseDto).collect(Collectors.toSet());
    ...
    public void deleteByID(Long id) {
        ...
        else throw new ResourceNotFoundException("The author with ID %d doesn't exist", id);
    }
    ...
    public void update(AuthorResponseDto authorResponseDto) throws Throwable {
        ...
        existingAuthor = authorRepo.findById(author.getId()).orElseThrow(() ->
                new ResourceNotFoundException("The author with ID %d is not found", author.getId()));
